...
#SBATCH --job-name=nosf_kgml03
#SBATCH --output=/users/8/zhan8460/Desktop/HydroDiffusion/logs/nosf_kgml03_%j.txt
#SBATCH --error=/users/8/zhan8460/Desktop/HydroDiffusion/logs/nosf_kgml03_err_%j.txt
