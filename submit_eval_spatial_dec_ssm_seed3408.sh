#!/bin/bash
#SBATCH --job-name=eval_spatial_3408
...
#SBATCH --output=logs/eval_spatial_3408_%j.txt
...
python3 main.py evaluate_npy   --model_name=decoder_only_ssm   --seed=3408   --gpu=0   --no_static=false   --concat_static=true   --run_dir=./runs/dec_ssm_spatial_seed3408   --epochs=60   --d_model=256   --d_state=256   --lr=3e-5   --lr_min=3e-6   --weight_decay=0.00   --wd=4e-5   --lr_dt=0.001   --min_dt=0.01   --max_dt=0.1   --warmup=1   --n_layer=6   --batch_size=128   --ssm_dropout=0.2   --cfi=10   --cfr=10   --pool_type=power   --predict_mode=velocity   --forcing_source=daymet   --stride=1   --basin_split_csv=/projects/standard/kumarv/shared/dwij/inverse/basin_assignment_v1.csv
