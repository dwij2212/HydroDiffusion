...
#SBATCH --job-name=eval_nosf_encdec_lstm_3407
...
#SBATCH --output=/users/8/zhan8460/Desktop/HydroDiffusion/logs/eval_nosf_encdec_lstm_3407_%j.txt
...
JOB_TEST_SH=/tmp/test_eval_nosf_encdec_lstm_3407_$$.sh
cp test.sh $JOB_TEST_SH
sed -i "s/^firstseed=.*/firstseed=3407/" $JOB_TEST_SH

bash $JOB_TEST_SH encdec_lstm static 0 /users/8/zhan8460/Desktop/HydroDiffusion/runs/encdec_lstm_nosf_seed3407
