...
def get_args() -> Dict:
    ...
    parser.add_argument('--variant', type=str, default='static',
                        choices=['static', 'z', 'z+static'])
    parser.add_argument('--emb_dim', type=int, default=32)
    parser.add_argument('--z_emb_path', type=str, default='')
    #====================================#
...
def main():
    ...
    if cfg["mode"] == "train":
        ...
        import sys
        sys.path.insert(0, '/users/8/zhan8460/Desktop/HydroDiffusion/yimeng_test')
        sys.path.insert(0, '/users/8/zhan8460/Desktop/HydroDiffusion')
        sys.path.insert(0, '/users/8/zhan8460/Desktop/HydroDiffusion/papercode')
        from train_npy import train
        train(cfg)
