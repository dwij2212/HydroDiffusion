...
#SBATCH --job-name=eval_spatial_3407
...
#SBATCH --output=/users/8/zhan8460/Desktop/HydroDiffusion/logs/eval_spatial_3407_%j.txt
...
python3 main.py evaluate_npy \
  ...
  --no_static=false \
  --concat_static=true \
  --run_dir=./runs/dec_ssm_spatial_seed3407 \
  --epochs=60 \
  --d_model=256 \
  --d_state=256 \
  --lr=3e-5 \
