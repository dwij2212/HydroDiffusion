...
run_dirs = [f"runs/dec_ssm_spatial_seed{seed}" for seed in seeds]
output_path = "/projects/standard/kumarv/zhan8460/HydroDiffusion_aggregated_spatial/dec_ssm_spatial_aggregated.npz"

print("=== Aggregating decoder_only_ssm spatial split ===")
aggregate_seeds(run_dirs, output_path)

subprocess.run([
    "python3", "analysis/main_performance_full_evaluation.py",
    "dec_ssm_spatial_aggregated",
    output_path
])
