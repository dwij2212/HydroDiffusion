...
#SBATCH --job-name=nosf_msigpu_02
#SBATCH --output=/users/8/zhan8460/Desktop/HydroDiffusion/logs/nosf_msigpu_02_%j.txt
#SBATCH --error=/users/8/zhan8460/Desktop/HydroDiffusion/logs/nosf_msigpu_02_err_%j.txt
